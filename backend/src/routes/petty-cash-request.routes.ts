...
router.put('/:id', authorize('pettyCashRequest.edit'), validate(updatePettyCashRequestSchema), pettyCashRequestController.update);
router.delete('/:id', authorize('pettyCashRequest.delete'), validate(pettyCashRequestIdParamSchema), pettyCashRequestController.remove);
